...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Gestión de Puestos</h1>
        <div class="float-sm-right">
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-backdrop="static" data-target="#modalImporUser"><i
                    class="fas fa-download fa-sm text-white-50"></i> Import Puestos</a>
            <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"data-toggle="modal" data-backdrop="static" data-target="#modalExportUser"><i
                    class="fas fa-download fa-sm text-white-50"></i> Exportar Puestos</a>
        </div>
    </div>

    <form action="{{ route('admin.import.puesto') }}" method="POST" enctype="multipart/form-data">
        @csrf
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Importar Puestos</h5>
