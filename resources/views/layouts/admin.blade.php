        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Seminter:</h6>
                        <a class="collapse-item" href="{{ route('admin.report.asalto')}}">Asalto</a>
                        <a class="collapse-item" href="{{ route('admin.report.sospechoso')}}">Presencia Sospechoso</a>
                        <a class="collapse-item" href="{{ route('admin.report.herido')}}">Herido</a>
                        <a class="collapse-item" href="{{ route('admin.report.incendio')}}">Incendio</a>
                        <a class="collapse-item" href="{{ route('admin.report.manifestacion')}}">Manifestaciones</a>
                        <a class="collapse-item" href="{{ route('admin.report.ausencia')}}">Ausencia relevo</a>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        ...
                                        <span class="font-weight-bold">Sin datos!</span>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Sin Datos.</div>
                                        <div class="small text-gray-500">Ayer · 58m</div>
                                    </div>
                                </a>
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                    ...
                                    <div>
                                        <div class="text-truncate">Mensaje de prueba?</div>
                                        <div class="small text-gray-500">Martes · 3d</div>
                                    </div>
                                </a>


                                <a class="dropdown-item text-center small text-gray-500" href="#">Leer todo</a>
                            </div>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6 mb-4">
                            <div class="card bg-danger text-white shadow">
                                <div class="card-body">
                                   Boton de Panico
                                    <div class="text-white-50 small">0 actualmente</div>
