        ...
        <div class="form-group">
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a href="{{ route("admin.country.create") }}" type="button" class="btn btn-primary float-sm-right">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.country.edit', $value->id) }}" type="button" class="btn btn-outline-primary ml-3">
